    ...
    methods: {
      initialize: function() {
        ...
        */
        ...
        var x5Type = this.x5Type
        if (x5Type) {
          this.$el.children[0].setAttribute('x5-video-player-type', x5Type)
          
        }
          var x5Fullscreen = this.x5Fullscreen
        if (x5Fullscreen) {
          this.$el.children[0].setAttribute('x5-video-player-fullscreen', x5Fullscreen)
